"""Pricebook Pro: the one in-app purchase, and the switch from paid to free.
...
PRODUCT_ID = "com.mattbusel.pricebook.pro"
NAME = "Pricebook Pro"
PRICE = "3.99"
DESCRIPTION = "Unlimited items, price history charts, CSV export."  # 55 chars max
REVIEW_NOTE = (
    "Non-consumable, one-time unlock. The app is free; barcode scanning, price verdicts, Check, Compare and the "
    "shopping list are free, with up to 30 items in the book. Pro unlocks unlimited items, the six-month price "
    "history chart on each item page, and the CSV export. To see the paywall: open any item on the Book tab and "
    "tap See the chart with Pro, or open Settings (gear on the Book tab) and tap See Pro. Restore purchase is on "
    "the paywall and in Settings under Pricebook Pro."
)
